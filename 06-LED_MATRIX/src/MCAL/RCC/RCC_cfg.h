 ...
 * AHP peripherals clock options:
 	 * 1) RCC_AHB1_SYSTEM_CLK
 	 * 2) RCC_AHB1_SYSTEM_CLK_DIVIDED_BY_2
 	 * 3) RCC_AHB1_SYSTEM_CLK_DIVIDED_BY_4
 	 * 4) RCC_AHB1_SYSTEM_CLK_DIVIDED_BY_8
 	 * 5) RCC_AHB1_SYSTEM_CLK_DIVIDED_BY_16
 	 * 6) RCC_AHB1_SYSTEM_CLK_DIVIDED_BY_64
 	 * 7) RCC_AHB1_SYSTEM_CLK_DIVIDED_BY_128
 	 * 8) RCC_AHB1_SYSTEM_CLK_DIVIDED_BY_256
 	 * 9) RCC_AHB1_SYSTEM_CLK_DIVIDED_BY_512
*/
